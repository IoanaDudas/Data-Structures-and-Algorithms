...
class SortedMap {
    ...
    //returns the TValue that appears most frequently in the SortedMap. If multiple TValues appear most frequently, returns any of them.
    //if the SortedMap is empty, the operation returns NULL_TVALUE
